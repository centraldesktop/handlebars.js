...
Handlebars.resetHelpersAndPartials = function() {
  this.helpers = {};
  this.partials = {};

  this.registerHelper('blockHelperMissing', function(context, fn, inverse) {
  ...
  this.registerHelper('each', function(context, fn, inverse) {
    var ret = "";
  ...
  this.registerHelper('if', function(context, fn, inverse) {
    if(!context || context == []) {
      return inverse(this);
    } else {
      return fn(this);
  ...
  this.registerHelper('unless', function(context, fn, inverse) {
    return Handlebars.helpers['if'].call(this, context, inverse, fn);
  });

  this.registerHelper('with', function(context, fn) {
    return fn(context);
  });
};
